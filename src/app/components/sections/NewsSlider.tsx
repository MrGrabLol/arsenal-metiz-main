...
export default function NewsSlider() {
  ...
  return (
    <section
      id="news"
      className="relative bg-brand-dark text-white py-12 sm:py-20 md:py-33.75"
    >
      <div className="max-w-base mx-auto relative z-10 space-y-7.5 px-4 md:px-12 lg:px-4">
          ...
          >
            {newsItems.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="relative h-87.5 group overflow-hidden rounded xs:rounded-md">
                  <Image
                  ...
                  />
                  <div className="absolute bottom-0 left-0 p-3 md:p-5 z-20">
                    <p className="font-inter text-xs md:text-sm text-gray-300 leading-3.5 mb-1">
                      {item.date}
                    </p>
                    <h5 className="font-medium leading-5 md:text-xl/6.5 mb-4">
                      {item.title}
                    </h5>
                    <Link
                      href={item.link}
                      className="font-inter inline-flex items-center text-xs/3.5 md:text-base/4 hover:underline"
                    >
                      Читать статью{" "}
                      <svg
                        width="8"
                        ...
                        className="w-1.5 h-2.5 md:size-auto ml-2.5 md:ml-4"
                      >
                        <path
        ...
        <div className="flex flex-col-reverse sm:flex-row items-end sm:items-center justify-between gap-12 md:gap-5">
