    ...
    <div className="space-y-4">
      <div className="space-y-6 bg-brand-whitish-200 border border-brand-dark-gray/30 rounded-md p-4 lg:p-6 2xl:p-8">
        <div className="flex-between flex-col sm:flex-row items-start sm:items-center gap-5">
          <h2 className="text-2xl lg:text-3xl font-medium">Организация</h2>
          <Button
            variant="white"
            className="flex items-center gap-3.75 !py-3.75"
          >
            <span className="text-xs lg:text-sm leading-4">
              Изменить данные
            </span>
            <svg
              width="20"
        ...
        <div className="flex gap-12.5">
          <div className="flex-1 h-fit grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7.5 pt-4">
            ...
            <label htmlFor="inn" className="block">
              <span className="text-sm lg:text-base font-medium">ИНН</span>
              <input
                id="inn"
                type="text"
            ...
            <label htmlFor="kpp" className="block">
              <span className="text-sm lg:text-base font-medium">КПП</span>
              <input
                id="kpp"
                type="text"
